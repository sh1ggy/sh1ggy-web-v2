export default function Skills() {
  ...
  return (
    <div className="bg-card flex flex-col space-y-12 flex-wrap rounded-2xl p-10 h-screen justify-center items-center select-none">
      ...
      <div className="flex flex-col justify-center items-center">
        ...
        <div className="flex flex-row justify-center items-center">
          {SOFT_SKILLS
            .map((s) => (
              <div className="bg-page rounded-xl shadow-lg p-3 mx-3 w-42 hover:bg-[#7280a3] transition-colors cursor-pointer">
