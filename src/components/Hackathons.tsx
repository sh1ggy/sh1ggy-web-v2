...
export const HACKATHONS: Project[] = [
  {
    ...
    desc: "Battle royale where the form of attach is the action of taking a photo",
    eventLink:
      "https://uqcs.org/competitions/hackathon-2023/",
    repo: "https://github.com/sh1ggy/pugb",
    tags: ["React Native", "Rust", "OAuth"],
  },
  {
    hack: "scribbly",
    date: "16-07-2023",
    ...
    <div className="flex flex-col space-y-6 p-10 lg:pb-96 lg:mx-14">
      ...
      <div className="lg:grid lg:grid-cols-3 gap-5 lg:space-y-0 space-y-3 flex flex-col rounded-2xl relative sm:mb-96">
        {HACKATHONS.map((h, i) => (
          <div
            key={i}
            className="flex flex-col bg-card shadow-md p-6 rounded-md justify-start hover:scale-105 transition-transform space-y-3"
          >
            <div className="flex flex-row">
              <div className="flex flex-col w-full">
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white">
                  <strong>{h.hack}</strong>
                </h3>
              ...
              <a
                href={h.repo}
                className="hover:text-link hover:scale-110 transition-transform"
              >
                <FaGithub size={20} />
              </a>
            </div>
            ...
            <div className="flex flex-col h-full">
              <a
                href={h.eventLink}
                className="flex mb-3 hover:text-link space-x-1 transition-colors items-center"
              >
              ...
              <p className="text-body font-normal mb-3 text-gray-500 dark:text-gray-400 break-words">
                {h.desc}
              </p>
