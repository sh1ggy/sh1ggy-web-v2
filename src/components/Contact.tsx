...
export default function Contact() {
  ...
  return (
    <div className="flex flex-col relative lg:flex-col space-y-8 flex-wrap rounded-2xl p-10 lg:h-[calc(screen-24px)] justify-center items-center select-none mb-10 lg:mx-14">
      {/* TOAST */}
